...
const article = computed(() => (canReadArticle(found.value, 'customer') ? found.value : null))
const noPermission = computed(() => !!found.value && !canReadArticle(found.value, 'customer'))
</script>
