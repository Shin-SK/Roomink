...
export const manualArticles = [
  ...
  },
  {
    ...
    steps: [
      '設定の「電話番号設定」を開く',
      '初回だけ、受付アプリ用のSIP IDとパスワードを保存する',
      '「設定用QRを発行」を押し、受付端末のLinphoneでQRコードを読み取る',
      '「新規作成」で受付電話番号を登録する',
      '電話番号・ラベル・メモなどを入力する',
    ...
    confirm: [
      ...
      'Linphoneが登録済みになり、テスト着信で受付端末が鳴ればOK',
    ],
    notes: [
      'マネージャー権限がないとこの画面は使えない',
  ...
  },
  {
    ...
    steps: [
      ...
      '「電話番号設定」で店舗のSIP IDとパスワードを保存し、設定用QRを発行する',
      '受付端末へLinphoneを入れ、QRコードを読み取る',
