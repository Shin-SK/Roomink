...
from core.models import Cast, CastNote, Course, Customer, Order, SmsLog, SmsTemplate, Store, UserProfile
    ...
    def test_sms_preview_renders_without_sending_or_writing(self):
        ...
        response = client.post(
            "/api/op/sms-templates/",
            {
                ...
                "scenario": "discount",
                "body": "{customer_name}様 {discount_name} -{discount_amount}円 合計{total_price}円",
            },
            format="json",
        )
