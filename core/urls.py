...
urlpatterns = [
    ...
    path("cast/orders/<int:pk>/options/", views.CastOrderOptionsView.as_view(), name="cast-order-options"),
    path("cast/orders/<int:pk>/start/", views.CastOrderStartView.as_view(), name="cast-order-start"),
    path("cast/orders/<int:pk>/complete/", views.CastOrderCompleteView.as_view(), name="cast-order-complete"),
